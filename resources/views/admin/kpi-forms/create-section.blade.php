<x-layouts.admin>
    ...
    <x-slot:header>
        <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
            <div>
                <h1 class="text-2xl font-bold">Tambah Seksi Baru</h1>
    ...
    <div class="">
        <x-ui.card>
            <form method="POST" action="{{ route('admin.kpi-forms.add-section', $version) }}" class="space-y-6">
                @csrf
                ...
                <x-ui.alert type="info">
                    <span>Seksi digunakan untuk mengelompokkan item penilaian berdasarkan kategori atau kriteria tertentu.</span>
                </x-ui.alert>
