                ...
                <tbody>
                    @forelse([] as $key => $report)
                        <tr>
                            <td>{{ $key + 1 }}</td>
                            <td>
                                <div class="font-semibold">{{ $report->name ?? 'Laporan Penilaian Guru - Periode 1' }}</div>
                            </td>
                            <td>
                            ...
                            <td>
                                <div class="text-sm">
                                    <div>{{ $report->created_at?->format('d M Y H:i') ?? now()->format('d M Y H:i') }}</div>
                            ...
                            <td>
                                <div class="flex gap-1">
                                    @if($status === 'ready')
                                        <x-ui.button variant="outline" size="xs" onclick="downloadExistingReport('{{ $report->id ?? '1' }}', 'pdf')">
