            ...
            <x-ui.card>
                <form method="POST" action="{{ route('admin.periods.store') }}" class="space-y-6">
                    ...
                    <div class="border-b border-base-200 pb-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <x-ui.input
                                name="scoring_open_at"
                                label="Tanggal Mulai"
                                type="datetime-local"
                            />
                            <x-ui.input
                                name="scoring_close_at"
                    ...
                    <div class="border-b border-base-200 pb-6">
                        ...
                        <x-ui.select
                            name="kpi_form_version_id"
                            label="Pilih Form KPI"
                            :options="$kpiForms ?? []"
                ...
                <div class="space-y-4 text-sm">
                    ...
                    <div class="flex gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-base-content/60">Lakukan pairwise comparison untuk menentukan bobot kriteria.</p>
                        </div>
                    </div>
                    <div class="flex gap-3">
                        <div class="w-8 h-8 rounded-full bg-base-200 flex items-center justify-center flex-shrink-0">
