                        ...
                        <tr class="hover">
                            ...
                            <td>
                                <div class="flex items-center gap-2">
                                    <progress class="progress progress-primary w-20" value="{{ $period->progress ?? 0 }}" max="100"></progress>
                            ...
                            <td class="text-right">
                                <div class="dropdown dropdown-end">
                                    ...
                                    <ul tabindex="0" class="dropdown-content z-[1] menu p-2 shadow-lg bg-base-100 rounded-box w-52">
                                        ...
                                        @endif
                                        <li><a onclick="document.getElementById('delete-{{ $period->id }}').showModal()" class="text-error">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <x-ui.modal id="delete-{{ $period->id }}" title="Hapus Periode">
                                    ...
                                    <p class="text-sm text-error mt-2">Semua data penilaian terkait periode ini akan dihapus!</p>
                                    <x-slot:actions>
                                        <form method="dialog">
                    ...
                    @empty
                        <tr>
                            <td colspan="7" class="text-center py-8 text-base-content/60">
                                ...
                                <x-ui.button type="primary" size="sm" href="{{ route('admin.periods.create') }}" class="mt-4">
