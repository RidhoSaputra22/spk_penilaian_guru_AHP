        ...
        <div class="card-body">
            <form action="{{ route('admin.assessments.index') }}" method="GET" class="flex flex-wrap gap-4">
                ...
                <div class="form-control flex-1 min-w-[200px]">
                    ...
                    <input type="text" name="search" value="{{ request('search') }}" placeholder="Nama guru..." class="input input-bordered" />
                </div>
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td>
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <div class="text-sm text-base-content/70">{{ $assessment->teacher->nip ?? '-' }}</div>
                                    </div>
                                </div>
                            </td>
                            <td>
                                <div class="flex items-center gap-2">
                                    <div class="avatar placeholder">
                                        <div class="bg-secondary/10 text-secondary rounded-full w-8">
                                            <span class="text-xs">{{ substr($assessment->assessor->user->name ?? '', 0, 2) }}</span>
                                        </div>
                                    </div>
                            ...
                            <td class="text-right">
                                <a href="{{ route('admin.assessments.show', $assessment) }}" class="btn btn-ghost btn-sm">
    ...
    <div class="modal-box max-w-2xl">
        ...
        <form action="{{ route('admin.assessments.assign') }}" method="POST" class="space-y-4">
            ...
            <div class="modal-action">
                <button type="button" class="btn btn-ghost" onclick="document.getElementById('assignModal').close()">Batal</button>
