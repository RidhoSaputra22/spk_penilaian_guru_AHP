            ...
            <x-ui.card>
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-sm text-base-content/60">Set Kriteria:
                            {{ $ahpModel->criteriaSet->name ?? 'N/A' }}</p>
                    </div>
                ...
                <div class="overflow-x-auto">
                    <table class="table table-xs">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="font-mono">1/3, 1/5...</td>
                                <td>Kebalikan dari skala di atas</td>
                            </tr>
                        </tbody>
                    </table>
                </div>
                ...
                <div class="space-y-3">
                    ...
                    <div class="flex items-center justify-between p-3 bg-base-200 rounded-lg">
                        ...
                        <div class="text-right">
                            <div class="text-lg font-bold text-primary">{{ number_format($weight->weight * 100, 2) }}%
                            </div>
            ...
            <x-ui.card title="Distribusi Bobot">
                <div class="space-y-2">
                    ...
                    <div>
                        ...
                        <progress class="progress progress-primary w-full" value="{{ $weight->weight * 100 }}"
                            max="100"></progress>
                    </div>
                    @endforeach
                </div>
